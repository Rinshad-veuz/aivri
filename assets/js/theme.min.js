...
// Override matchMedia to ignore dark mode preference
window.matchMedia = function(query) {
  if (query === '(prefers-color-scheme: dark)') {
    return {
      matches: false, // always pretend dark mode is off
      media: query,
      onchange: null,
      addEventListener: () => {},
      removeEventListener: () => {},
  ...
  return window.originalMatchMedia(query);
};

// Backup original matchMedia for other media queries
window.originalMatchMedia = window.originalMatchMedia || window.matchMedia;
